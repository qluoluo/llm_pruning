...
if __name__ == "__main__":
    args = parse_args()
    # models = [
        # "internlm2-base-7b", "internlm2-chat-20b", "internlm2-20b",
        # "internlm2-chat-20b-sft", "internlm2-7b", "internlm2-chat-7b",
        # "internlm2-base-20b",  "internlm2-chat-7b-sft"
        # "internlm2-chat-1_8b-sft"
    # ]
    # for model in models:
        # src = os.path.join("/mnt/inspurfs/xingshuhao/repo/huggingface_repo", model)
        # tgt = os.path.join("/mnt/inspurfs/xingshuhao/repo/internlm-llama", model + "-llama")
        # print(tgt)
