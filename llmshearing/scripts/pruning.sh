...
LAUNCH_SCRIPT=${PROJ_DIR}/llmshearing/scripts/launch.sh
DATA_DIR=${PROJ_DIR}/data_bin/moss_sampled/for_prune
...
path=$MODEL_PATH/internlm2_composer.pt
...
# save directroy
run_name=internlm_${from_model}_pruning_scaling_${update_type}_to${to_model}_sl${max_seq_len}_v3
